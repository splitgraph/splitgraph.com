...
- Where can I deploy my version of this data? How do I get it into the warehouse?
...
[**Splitfiles**](/docs/concepts/splitfiles) give you a declarative language, inspired by Dockerfiles, for expressing data transformations in ordinary SQL that any researcher and business analyst knows. You can reference other images, or even other databases, [with a simple `JOIN`](/docs/splitfiles/splitfile-sql).
...
any PostgreSQL client. Splitgraph will capture your changes to the data, and then you can commit them with as **delta compressed changesets** that you can package into new images.
