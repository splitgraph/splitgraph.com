...
<dt id="splitgraph.engine.postgres.engine.PsycopgEngine.in_fdw">
<code className="sig-name descname"><span className="pre">in_fdw</span></code><a className="headerlink" href="#splitgraph.engine.postgres.engine.PsycopgEngine.in_fdw" title="Permalink to this definition">¶</a></dt>
