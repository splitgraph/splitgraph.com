...
[`sgr provenance --full`](../sgr/splitfile_execution/provenance)) before running [`sgr rebuild`](../sgr/splitfile_execution/rebuild), as rebuilding runs SQL from the image's metadata,
