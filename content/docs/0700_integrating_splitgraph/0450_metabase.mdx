...
You can also use a Splitgraph engine managed by [`sgr engine`](../sgr/engine_management/engine_add): you will have to connect it to the Docker network set up by Metabase. For example:
