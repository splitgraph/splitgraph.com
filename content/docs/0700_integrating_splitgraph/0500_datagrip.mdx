...
A good sample query is just plotting the geometry column in the dataset. This column is in the
 [British National Grid](https://epsg.io/27700) and we need to convert it to the standard
