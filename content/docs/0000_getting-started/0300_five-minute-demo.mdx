...
You also have an OpenAPI-compatible [REST API](/splitgraph-demo/votes_by_state/latest/-/api-schema) generated for the dataset, provided by [PostgREST](https://postgrest.org/en/latest/). More perks like this coming soon.
