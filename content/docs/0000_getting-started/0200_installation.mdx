...
see [the CLI reference](../sgr/engine-management/engine_add).
...
You can take a look at the [five minute demo](five_minute_demo) that will go through the basics of building
