...
[**Splitgraph.com**, or **Splitgraph Cloud**](../splitgraph-cloud/introduction), is a public Splitgraph instance where you can share and discover data. It's a Splitgraph peer powered by the **Splitgraph Core** code, adding proprietary features like:
...
We have a [dedicated section](../splitgraph-cloud/introduction) for Splitgraph Cloud.
...
No. You can use Splitgraph in a decentralized way, sharing data between two engines like you would
...
get or share public data, query your datasets through the [Data Delivery Network](../splitgraph-cloud/data-delivery-network) or have a [REST API](../splitgraph-cloud/publish-rest-api) generated for your dataset.
