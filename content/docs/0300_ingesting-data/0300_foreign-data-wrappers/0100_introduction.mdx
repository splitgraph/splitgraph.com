...
In Splitgraph terminology, this is called "mounting", kind of like mounting a filesystem to mount points in the directory tree. These mounted tables can then be snapshotted and turned into Splitgraph images with just one command, [`sgr import`](../../sgr/image-management-creation/import).
