...
Splitgraph SQL endpoint, or Splitgraph Data Delivery Network (DDN) is a feature of Splitgraph Cloud. It's a PostgreSQL-compatible SQL endpoint hosted at `postgresql://data.splitgraph.com:5432/ddn` that lets you query any dataset hosted on or indexed by Splitgraph.
