...
Every public dataset on the Splitgraph registry has a read-only OpenAPI-compatible endpoint that can be used to query it, provided by [PostgREST](https://postgrest.org/en/latest/). It can be accessed by curl:
