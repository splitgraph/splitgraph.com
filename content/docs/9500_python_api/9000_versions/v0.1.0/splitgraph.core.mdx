...
<code className="sig-name descname">pull</code><span className="sig-paren">(</span><em className="sig-param">download_all: Optional[bool] = False</em>, <em className="sig-param">overwrite: bool = False</em><span className="sig-paren">)</span> → None<a className="headerlink" href="#splitgraph.core.repository.Repository.pull" title="Permalink to this definition">¶</a></dt>
...
<code className="sig-name descname">push</code><span className="sig-paren">(</span><em className="sig-param">remote_repository: Optional[Repository] = None</em>, <em className="sig-param">overwrite: bool = False</em>, <em className="sig-param">handler: str = 'DB'</em>, <em className="sig-param">handler_options: Optional[Dict[str</em>, <em className="sig-param">Any]] = None</em><span className="sig-paren">)</span> → splitgraph.core.repository.Repository<a className="headerlink" href="#splitgraph.core.repository.Repository.push" title="Permalink to this definition">¶</a></dt>
...
<code className="sig-name descname">reindex</code><span className="sig-paren">(</span><em className="sig-param">extra_indexes: Dict[str, Dict[str, Dict[str, Any]]], raise_on_patch_objects=True</em><span className="sig-paren">)</span> → List[str]<a className="headerlink" href="#splitgraph.core.table.Table.reindex" title="Permalink to this definition">¶</a></dt>
