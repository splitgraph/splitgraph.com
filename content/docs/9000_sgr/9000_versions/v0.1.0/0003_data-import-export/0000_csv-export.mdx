export const meta = {id: "csv-export", title: "sgr csv export", sidebarTitle: "csv export", description: "Export the result of a query as CSV."};

```sgr csv export [OPTIONS] IMAGE_SPEC QUERY```
