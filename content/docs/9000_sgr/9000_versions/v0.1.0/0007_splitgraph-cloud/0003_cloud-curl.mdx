export const meta = {
  id: "cloud-curl",
  title: "sgr cloud curl",
  sidebarTitle: "cloud curl",
  description: "Query a Splitgraph REST API.",
};
...
interact with a dataset using PostgREST (https://postgrest.org) or the Splitfile execution service.
...
- For PostgREST: `/table?[postgrest request]` or empty to get the OpenAPI spec for this image.
  For a reference on how to perform Postgrest requests, see https://postgrest.org/en/latest/api.html.
