...
By default, Splitgraph has a remote `data.splitgraph.com` registered for it. To add another remote,
add this to your `.sgconfig`:
...
The [next page](config_flag_reference) lists all flags supported by the configuration file.
