...
Every public dataset on the Splitgraph registry has a read-only OpenAPI-compatible endpoint that can be used to query it, provided by [PostgREST](http://postgrest.org/). It can be accessed by curl:
