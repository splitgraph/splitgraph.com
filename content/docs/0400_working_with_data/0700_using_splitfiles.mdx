...
For more information on the available Splitfile commands, see [the reference](../splitfiles/splitfile_intro).
...
[Link to example](https://github.com/splitgraph/splitgraph/tree/master/examples/us-election)
