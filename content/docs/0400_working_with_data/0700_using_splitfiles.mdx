...
For more information on the available Splitfile commands, see the [Splitfile command reference](../splitfiles/splitfile_intro).
...
[2016 US Epection example](https://github.com/splitgraph/splitgraph/tree/master/examples/us-election)
